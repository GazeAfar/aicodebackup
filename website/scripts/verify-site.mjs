...
const required = [
  ...
  ["open graph image", 'property="og:image" content="https://www.aicodebackup.com/assets/social-preview.svg"'],
  ["twitter card", 'name="twitter:card"'],
  ["twitter image", 'name="twitter:image" content="https://www.aicodebackup.com/assets/social-preview.svg"'],
...
for (const path of ["styles.css", "assets/product-preview.svg", "assets/social-preview.svg", "favicon.svg"]) {
